...
# Load pickled files
pkl_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
try:
    cv = pickle.load(open(os.path.join(pkl_path, 'count_vectorizer.pkl'), 'rb'))
    tfidf_transformer = pickle.load(open(os.path.join(pkl_path, 'tfidf_transformer.pkl'), 'rb'))
    feature_names = pickle.load(open(os.path.join(pkl_path, 'feature_names.pkl'), 'rb'))
except Exception as e:
